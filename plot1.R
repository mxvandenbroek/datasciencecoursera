...
#construct the plot:
with(data, hist(Global_active_power, col = "red", cex.axis = 0.7, cex.main =0.8,
                main = "Global Active Power", xlab ="", ylab = "" ))
title( ylab = "Frequency", xlab = "Global Active Power (kilowatts)"   , cex.lab = 0.7   )
